    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100">
      ...
      >
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="min-w-[40px] flex-2 rounded-2xl border border-slate-300 bg-white px-5 shadow-sm transition focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-100">
            <input
              name="location"
              className="h-12 w-full bg-transparent text-base text-slate-800 outline-none placeholder:text-slate-400"
          ...
          <input 
            type="submit" 
            value="Search"
            className="rounded-2xl bg-blue-600 px-7 py-3 font-semibold text-white shadow-sm transition hover:bg-blue-700 cursor-pointer"
          />

          <button
            type="button"
            onClick={() => setIsSideMenuOpen(true)}
            className="rounded-2xl border border-slate-300 bg-white px-4 py-3 text-2xl font-bold leading-none text-slate-700 shadow-sm hover:bg-slate-50 cursor-pointer "
